...
to create a decentralized platform to leverage assets within the crypto eco-system. Currently individuals have a lenghty process to exit the market and in many instances do not wish to
...
borrower can still release the value which the lender recieves the interest agreed + original capital.
